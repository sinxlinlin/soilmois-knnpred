# -*- coding: utf-8 -*-
"""
Created on Wed Aug 17 19:18:18 2022
...
data = pd.read_excel(r'D:\SEMESTER 8\SKRIPSI\DATA SKRIPSI/dataset_imp_KNN_5param_juni-juli.xlsx')
data.head()
df = pd.DataFrame(data, columns=['HST','Kelembaban relatif (%)','Kadar air tanah (%)','Suhu tanah (°C)','Relay (ml)','Kadar air tanah+1 (%)'])

train, test = train_test_split(df, test_size=0.2, random_state=65)
...
datauji = pd.read_excel(r'D:\SEMESTER 8\SKRIPSI\DATA SKRIPSI/dataset_imp_uji_KNN_5param_juni-juli.xlsx')
